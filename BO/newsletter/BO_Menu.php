...
?>
    ...
    <html>
      <head>
        <title>Administration des newsletters - Site Builder</title>
      ...
      <body>
        ...
        <div class="panel-flex-container">
          <div class="img left-panel left-panel-grey" style="background-image:url(<?php echo $monPDO->generalsettings_SelectParId('headerImg')['settingValue']; ?>);">
            ...
            <p>Ceci est l'interface d'administration de la newsletter associée à votre site Internet.<br>
              Vous y trouverez divers outils pour la gérer et en envoyer de nouvelles.<br>
              Notez que ce CMS est encore en cours de développement. Il peut donc comporter des incohérences ou manquer de certaines fonctionnalités. Merci de votre compréhension.
              ...
              <table class="table table-striped" style="background-color:white; text-align:left;">
                ...
                <?php
                $historiqueNewsletter = $monPDO->historique_selectNewsletter();
            ...
            <ul class="nav nav-pills nav-stacked">
              <li role="presentation" class="active"><a href="#">Accueil de l'administration</a></li>
