      ...
      <body>
        ...
        <div class="panel-flex-container">
          <div class="img left-panel left-panel-grey" style="background-image:url(<?php echo $monPDO->generalsettings_SelectParId('headerImg')['settingValue']; ?>);">
            ...
            <p>Ceci est l'interface d'administration des adhérents inscrits sur votre site Internet.<br>
              Vous y trouverez divers outils pour les gérer et les aider s'ils perdent l'accès à leur compte.
              ...
              <table class="table table-striped" style="background-color:white; text-align:left;">
                ...
                <?php
                $historiqueNewsletter = $monPDO->historique_selectAdherents();
            ...
            <ul class="nav nav-pills nav-stacked">
              <li role="presentation" class="active"><a href="#">Accueil de l'administration des adhérents</a></li>
