...
<html>
  <head>
    <title>Accès refusé - Administration - Mon Site</title>
  ...
  <body>
    ...
    <div class="content">
      <h2>Accès refusé</h2>
      <div class="alert alert-info" role="alert">Veuillez vous connecter pour accéder à cette section du site.</div>
    </div>
