            ...
            if(isset($_SESSION['id']))
            {
              switch ($_SESSION['rang']) {
                ...
                case 'adherent':
                  ...
                  <ul class="dropdown-menu">
                    <li class="dropdown-header">Mon compte</li>
                    <li><a href="ADH_Profil.php">Profil</a></li>
                    <li><a href="ADH_Securite.php">Sécurité du compte</a></li>
                    <li><a href="ADH_Preferences.php">Préférences</a></li>
                    <li role="separator" class="divider"></li>
                    <li><a href="ADH_Deconnexion.php">Déconnexion</a></li>
                  </ul>
                  <?php
                  }
                  else {
